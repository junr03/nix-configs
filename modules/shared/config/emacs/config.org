...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Jose Ulises Nino Rivera"
    user-mail-address "junr03@users.noreply.github.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/junr03/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/junr03/bin" "/profile/bin" "/Users/junr03/.npm-packages/bin" "/Users/junr03/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
